...
abstract class $MainStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ScreenState screenState, int currentIndex});
}
...
class _$MainStateImpl implements _MainState {
  const _$MainStateImpl(
      {this.screenState = ScreenState.home, this.currentIndex = 0});
  ...
  @override
  String toString() {
    return 'MainState(screenState: $screenState, currentIndex: $currentIndex)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, screenState, currentIndex);
...
abstract class _MainState implements MainState {
  const factory _MainState(
      {final ScreenState screenState,
      final int currentIndex}) = _$MainStateImpl;
